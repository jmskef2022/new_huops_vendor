...
class VendorDetailsViewModel extends MyBaseViewModel {
  ...
  void openImagesGalley() async {
    await viewContext.navigator.pushNamed(AppRoutes.mygallary);
    notifyListeners();
  }
  void openTables() async {
    await viewContext.navigator.pushNamed(AppRoutes.tables);
    notifyListeners();
  }

    void openImagesCoupons() async {
    await viewContext.navigator.pushNamed(AppRoutes.CouponsPage);
    notifyListeners();
  }
